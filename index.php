...
<link rel="icon" type="image/x-icon" href="new1/Purple_Yellow_Black_Neon_SciFi_YouTube_Icon.png">
<meta charset="UTF-8">
...
<div class="w3-top">
  <div class="w3-bar w3-red w3-card w3-left-align w3-large">
    ...
    <a href="find.html" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Find</a>
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium w3-large">
    ...
    <a href="find.html" class="w3-bar-item w3-button w3-padding-large">Find</a>
...
<header class="w3-container w3-red w3-center" style="padding:128px 16px">
  <picture>
  <source media="(min-width: 650px)" srcset="new1/OIP.jpg">
  <source media="(min-width: 465px)" srcset="new1/OIP1.jpg">
  <img src="new1/OIP2.jpg" style="width:auto;">
</picture>
  <h1 class="w3-margin w3-jumbo">Website Checker</h1>
  <p class="w3-xlarge">Know about Real Site and Fake Site</p>
